...
description: "Recibí eventos firmados en tu servidor. Acción + datos custom para tu integración directa. Plan Business."
---
...
Si no validas el HMAC, cualquiera podría postearte fake events. Validá siempre.
